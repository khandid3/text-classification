...
Now I want to call this model from my notebook in Google Colab. However, I got an error when I want to import automl_v1 from google.cloud package. I was not able to fix it yet. 
